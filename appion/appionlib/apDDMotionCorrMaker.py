...
class MotionCor3AlignStackLoop(MotionCor2UCSFAlignStackLoop):
	...
	def setupParserOptions(self):
		...
		self.parser.add_option("--inskips", dest="inskips", type=list, default=[], help="1. Used in combination with -Serial, skip the input files whose names contain the strings specied here.")
